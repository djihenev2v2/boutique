...
<body class="bg-[#f8f9fb] min-h-screen font-sans antialiased">
    ...
    <aside id="sidebar" class="fixed top-0 left-0 z-50 h-screen w-[260px] bg-white/80 backdrop-blur-xl rounded-r-3xl flex flex-col -translate-x-full lg:translate-x-0 transition-transform duration-200 ease-out shadow-[0px_20px_40px_rgba(24,57,110,0.06)]">  
        ...
        <nav class="flex-1 overflow-y-auto py-5 px-3 space-y-0.5">
            ...
            {{-- Commandes --}}
            <a href="#"
               class="group flex items-center gap-3 px-4 py-2.5 rounded-full text-[13px] font-medium transition-all duration-150 {{ request()->routeIs('admin.commandes*') ? 'bg-[#18396e] text-white shadow-lg' : 'text-[#5d5f5f] hover:bg-[#f2f4f6] hover:text-[#18396e]' }}">
                <svg class="w-[18px] h-[18px] flex-shrink-0 {{ request()->routeIs('admin.commandes*') ? 'text-white' : 'text-[#747780] group-hover:text-[#18396e]' }}" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">
            ...
            {{-- Clients --}}
            <a href="#"
               class="group flex items-center gap-3 px-4 py-2.5 rounded-full text-[13px] font-medium transition-all duration-150 {{ request()->routeIs('admin.clients*') ? 'bg-[#18396e] text-white shadow-lg' : 'text-[#5d5f5f] hover:bg-[#f2f4f6] hover:text-[#18396e]' }}">
                <svg class="w-[18px] h-[18px] flex-shrink-0 {{ request()->routeIs('admin.clients*') ? 'text-white' : 'text-[#747780] group-hover:text-[#18396e]' }}" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">
            ...
            {{-- Paramètres --}}
            <a href="#"
               class="group flex items-center gap-3 px-4 py-2.5 rounded-full text-[13px] font-medium transition-all duration-150 {{ request()->routeIs('admin.parametres*') ? 'bg-[#18396e] text-white shadow-lg' : 'text-[#5d5f5f] hover:bg-[#f2f4f6] hover:text-[#18396e]' }}">
