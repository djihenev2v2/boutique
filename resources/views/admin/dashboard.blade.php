...
<div class="flex items-center justify-between mb-7">
    <div>
        <h2 class="text-xl font-bold text-b-800 tracking-tight">Bonjour, {{ Auth::user()->name }} 👋</h2>
        <p class="text-slate-400 text-[13px] mt-0.5">Voici le résumé de votre activité du jour</p>
    </div>
    <div class="hidden sm:flex items-center gap-2 bg-white border border-b-200/30 rounded-xl px-4 py-2.5 shadow-sm">
        <svg class="w-4 h-4 text-b-600" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">
...
<div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 lg:gap-5 mb-8">
    ...
    {{-- Chiffre d'affaires --}}
    <div class="bg-white rounded-2xl border border-b-200/25 p-5 shadow-sm transition-all duration-200 hover:shadow-[0_8px_32px_-4px_rgba(24,57,110,0.14)] hover:-translate-y-0.5">
        <div class="flex items-start justify-between mb-4">
            ...
            <div class="w-10 h-10 rounded-xl flex items-center justify-center bg-b-100">
                <svg class="w-5 h-5 text-b-700" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75"/>
                </svg>
            </div>
        </div>
        <p class="text-[28px] font-bold text-b-800 leading-none">0 DA</p>
    ...
    <div class="bg-white rounded-2xl border border-b-200/25 p-5 shadow-sm transition-all duration-200 hover:shadow-[0_8px_32px_-4px_rgba(24,57,110,0.14)] hover:-translate-y-0.5">
        ...
        <p class="text-[28px] font-bold text-b-800 leading-none">0</p>
        <div class="flex items-center gap-1.5 mt-2">
            <span class="inline-flex items-center gap-0.5 text-[11px] font-semibold text-emerald-600 bg-emerald-50 rounded-full px-2 py-0.5">
                <svg class="w-2.5 h-2.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 10.5L12 3m0 0l7.5 7.5M12 3v18"/></svg>
                +5.2%
...
<div class="grid grid-cols-1 xl:grid-cols-3 gap-5">
    ...
    {{-- Commandes récentes --}}
    <div class="xl:col-span-2 bg-white rounded-2xl border border-b-200/25 shadow-sm overflow-hidden">
        <div class="flex items-center justify-between px-6 py-4 border-b border-b-100">
            <h3 class="text-[15px] font-bold text-b-800">Commandes Récentes</h3>
            <a href="#" class="text-[12px] font-medium text-b-600 hover:text-b-800 hover:underline">Voir tout</a>
        </div>
                        ...
                        <td colspan="5" class="px-6 py-14 text-center">
                            <div class="flex flex-col items-center">
                                <div class="w-14 h-14 rounded-2xl flex items-center justify-center mb-3 bg-b-50">
                                    <svg class="w-7 h-7 text-b-400" fill="none" stroke="currentColor" stroke-width="1.25" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007z"/>
                                    </svg>
                                </div>
    ...
    <div class="flex flex-col gap-5">
        ...
        {{-- Best-sellers --}}
        <div class="bg-white rounded-2xl border border-b-200/25 shadow-sm overflow-hidden">
            <div class="flex items-center justify-between px-5 py-4 border-b border-b-100">
                <h3 class="text-[15px] font-bold text-b-800">Best-Sellers</h3>
                <button class="p-1.5 text-slate-400 hover:text-b-700 hover:bg-b-50 rounded-lg transition-colors">
            ...
            <div class="px-5 py-4 space-y-3">
                ...
                <div class="flex flex-col items-center py-6 text-center">
                    <div class="w-12 h-12 rounded-xl flex items-center justify-center mb-2.5 bg-b-50">
                        <svg class="w-6 h-6 text-b-400" fill="none" stroke="currentColor" stroke-width="1.25" viewBox="0 0 24 24">
        ...
        {{-- Promo banner --}}
        <div class="rounded-2xl p-5 bg-b-800 shadow-lg shadow-b-800/25">
            ...
            <button class="bg-white/20 hover:bg-white/30 border border-white/25 text-white text-[12px] font-semibold px-4 py-2 rounded-lg transition-all shadow-sm">
                Découvrir
            </button>
        </div>
    </div>
